...
for i in range(56,82+1):
	for j in range(42,47+1):
		lNorthAfrica.append((i,j))

for i in range(79,84+1):
	for j in range(36,42+1):
		lNorthAfrica.append((i,j))

for i in range(63,68+1):
	for j in range(29,32+1):
		lNorthAfrica.append((i,j))

# Middle East
for i in range(83,98+1):
	for j in range(40,50+1):
		lMiddleEast.append((i,j))

for i in range(80,102+1):
	for j in range(51,54+1):
		lMiddleEast.append((i,j))

for i in range(83,89+1):
