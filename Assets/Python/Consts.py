...
iAmerica, iArgentina, iBrazil, iBoers, iCanada) = range(iNumPlayers)
...
pAmerica, pArgentina, pBrazil, pBoers, pCanada) = [gc.getPlayer(i) for i in range(iNumPlayers)]
...
teamAmerica, teamArgentina, teamBrazil, teamBoers, teamCanada) = [gc.getTeam(i) for i in range(iNumPlayers)]
...
(iCivAmerica, iCivArabia, iCivArgentina, iCivAztec, iCivBabylonia, iCivBoers, iCivBrazil, iCivByzantium, iCivCanada, iCivCarthage, iCivCelt, 
...
lCivGroups = [[iGreece, iRome, iByzantium, iVikings, iMoors, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iItaly, iPoland, iPortugal, iGermany],  #Euros
		...
		[iEgypt, iCarthage, iEthiopia, iMali, iCongo, iBoers], #African
...
lTechGroups = [[iRome, iGreece, iByzantium, iVikings, iSpain, iFrance, iEngland, iHolyRome, iRussia, iNetherlands, iPoland, iPortugal, iItaly, iGermany, iAmerica, iArgentina, iBrazil, iCanada, iBoers], #Europe and NA
...
iGeorge, iKruger, iMandela) = range(iNumLeaders)
